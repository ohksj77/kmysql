...
class SavepointRecord(private val page: Page) : LogRecord {
    ...
    override fun toString(): String = "<SAVEPOINT $transactionId $savepointName>"
    ...
    companion object {
        fun writeToLog(lm: LogManager, transactionId: Long, savepointName: String): Int {
            ...
            page.setInt(0, Operator.SAVEPOINT.id)
